...
$config['csrf_exclude_uris'] = ['Master/Wilayah/Kecamatan/Lists', 'Blog/Post/lists', 'Elfinder_lib/connector', 'Blog/Categories/lists', 'Sports/Categories/Lists', 'Sports/Venue/Lists'];
