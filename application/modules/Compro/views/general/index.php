<div class="card card-custom">
    <div class="card-body">
        ...
        if ($privilege['create']) { // jika memiliki privilege tambah data / create
            ...
            . '<button class="btn btn-primary mr-2" data-toggle="modal" data-target="#modal_add"><i class="far fa-plus-square"></i> Add new</button>'
            . '</div>'
            . '</div>';
...
<script>
    window.onload = function () {
        ...
        var table = $('table').dataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Compro/General/Lists/') ?>",
                "type": "POST",
                "dataType": "json"
            },
            columnDefs: [
