    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            <a href="javascript:void(0);">
                <img alt="company_logo" src="<?php echo base_url('assets/images/systems/' . $this->bodo->Sys('logo')); ?>" class="img-fluid" style="margin: 15px 0px;max-width: 15%;"/>
            </a>
            ...
            <div class="d-flex flex-row flex-column-fluid page">
                ...
                <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <script src="<?php echo base_url('assets/@fortawesome/fontawesome-free/js/all.min.js'); ?>" type="text/javascript"></script>
