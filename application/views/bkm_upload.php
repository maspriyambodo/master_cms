    ...
    <body>
                ...
                <form action="bkm-save" method="post" enctype="multipart/form-data">
                    <div class="row section">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group mt-2">
                                <label title="provinsi wajib diisi">Provinsi:<span class="text-danger">*</span></label>
                                <select id="provinsi" name="provtxt" class="form-control custom-select" required="" onchange="Provinsi(this.value);">
                                    <option value="">Pilih Provinsi</option>
                                    <?php
                                    foreach ($prov as $dt_prov) {
                                        echo '<option value="' . $dt_prov->id_provinsi . '">' . $dt_prov->nama . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
        ...
        <script type="text/javascript">
            ...
            function Provinsi(id) {
                ...
                $.ajax({
                    url: "<?php echo base_url('bkm-getkab?id_provinsi='); ?>" + id,
                    type: 'get',
                    dataType: 'json',
                    cache: false,
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
                        <h4>Tentang Kami</h4>
                        <h3 class="b" style="display:none;"><a href="https://scentivaid.com/">scentivaid</a><a href="http://bengkelbatursamy.com/">bengkel batur samy</a></h3>
                        <p>Kami adalah bagian dari Kementerian Agama Republik Indonesia di bawah naungan Direktorat Jenderal Bimbingan Masyarakat Islam yang menyajikan seluruh informasi mengenai masjid dan musholla di seluruh wilayah Republik Indonesia.</p>
                        <div class="footer-logo">
                            <img src="https://simas.kemenag.go.id/assets/front/img/logo.png" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
                        ...
                        <div class="footer-address">
                            <p>Alamat : Direktorat Jenderal Bimbingan Masyarakat Islam<br>Gedung Kementerian Agama RI Lt.6<br>Jl. M. H. Thamrin No. 6, Jakarta 10340</p>
                            <span>Hunting : (+6221) 3812871</span>
                            <span>Phone : (+6221) 31924509 - 3193056 - 3920774</span>
                            <span>Email : kemasjidan@kemenag.go.id</span>
                            <span>PO.BOX. 3733 JKP 10037</span>                    </div>
                    </div>

                    <div class="col-lg-2 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
                        <h4>Peta Situs</h4>
                        <ul>
                            <li class="nav-item"><a class="nav-link" href="https://simas.kemenag.go.id/page/profilmasjid">Profil Masjid</a></li><li class="nav-item"><a class="nav-link" href="https://simas.kemenag.go.id/page/profilmushalla">Profil Mushalla</a></li><li class="nav-item"><a class="nav-link" href="https://simas.kemenag.go.id/page/download">Unduh Data</a></li><li class="nav-item"><a class="nav-link" href="https://simas.kemenag.go.id/page/news">Info Terkini</a></li><li class="nav-item"><a class="nav-link" href="https://simas.kemenag.go.id/page/contactus">Kontak Kami</a></li>                    </ul>
                    </div>
                ...
                <div class="footer-bottom row align-items-center text-center text-lg-left no-gutters">
                    ...
                    <div class="col-lg-4 col-md-12 text-center text-lg-right footer-social">
                        <span class="small-face">This template powered by <a href="https://colorlib.com" target="_blank">Colorlib</a><span>
                            </span></span></div>
                </div>
        ...
        <script>
            var base_url = 'https://simas.kemenag.go.id/';
        </script>
        <!-- <script src="https://simas.kemenag.go.id/assets/front/js/jquery-2.2.4.min.js"></script> -->
        <script src="https://simas.kemenag.go.id/assets/front/js/popper.js"></script>
        <script src="https://simas.kemenag.go.id/assets/front/js/bootstrap.min.js"></script>
        <script src="https://simas.kemenag.go.id/assets/front/vendors/owl-carousel/owl.carousel.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js" integrity="sha512-2ImtlRlf2VVmiGZsjm9bEyhjGW4dU7B6TNwh/hx/iSByxNENtj3WVE6o/9Lj4TJeVXPi4bnOIMXFIJJAeufa0A==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        <script src="https://simas.kemenag.go.id/assets/front/js/jquery.ajaxchimp.min.js"></script>
        <script src="https://simas.kemenag.go.id/assets/front/js/waypoints.min.js"></script>
        <script src="https://simas.kemenag.go.id/assets/front/js/jquery.form.js"></script>
        <script src="https://simas.kemenag.go.id/assets/front/js/jquery.validate.min.js"></script>
        <script src="https://simas.kemenag.go.id/assets/front/js/utils.js"></script>
